# Legacy: Claude + TradingView MCP — Automated Trading

> **This is the original tutorial documentation**, kept for reference. It
> describes the cron-based `bot.js` + TradingView MCP + BitGet workflow the
> project started from. The current system — the Alpaca streaming bot with
> strategy routing — is documented in the main [README](../README.md).
